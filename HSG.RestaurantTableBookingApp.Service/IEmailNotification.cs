...
namespace HSG.RestaurantTableBookingApp.Service
{
    public interface IEmailNotification
    {
        ...
        Task<Response> SendCheckInEmailAsync(DiningTalbeWithTimeSlotModel model);
    }
    public class EmailNotification : IEmailNotification
    {
        ...
        public async Task<Response> SendCheckInEmailAsync(DiningTalbeWithTimeSlotModel model)
        {
        ...
        private string GetBookingEmailBody(ReservationModel model, RestaurantReservationDetails reservationDetails, bool isReminderEmail)
        {
            ...
            return $$"""
                    ...
                    <body>
                        ...
                        <p>[HSG Restaurant,]<br>{{reservationDetails.RestaurantName}}<br>[Contact Information]</p>
                    </body>
                    </html>                    
                    """;
        }
