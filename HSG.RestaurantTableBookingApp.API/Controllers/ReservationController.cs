...
namespace HSG.RestaurantTableBookingApp.API.Controllers
{
    ...
    public class ReservationController : ControllerBase
    {
        ...
        public ReservationController(IReservationService reservationService, IEmailNotification emailNotification,
        ...
        public async Task<ActionResult<ReservationModel>> CheckInReservationAsync(DiningTalbeWithTimeSlotModel reservation)
        {
